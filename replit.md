...
- **Points Banner**: Live running points total shown at the top of the dashboard (below InfiniteGoalBanner). Animates the counter and triggers a burst animation + haptic whenever points increase.
