...
- **Nav**: Icon-only tabs for all 4 pages (Home, History, Trends, Team); active tab shows a short label beneath the icon. Swipe left/right anywhere in the main content area to navigate between pages (60px threshold, horizontal-dominant only).
