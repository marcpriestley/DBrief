      ...
      <div className="max-w-2xl mx-auto px-5 py-8 space-y-8">
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-sm text-foreground/80 leading-relaxed">
            By creating an account or using DBrief in any way, you agree to these Terms. If you do not agree, please do not use the app.
          </p>
        </div>

        <Section icon={<User className="h-4 w-4" />} title="1. Who We Are">
          <p className="text-sm text-foreground/75 leading-relaxed">
            DBrief is a personal performance app operated by Marc Priestley. Questions about these Terms? Email us at{" "}
        ...
        <Section icon={<User className="h-4 w-4" />} title="2. Your Account">
          <ul className="space-y-2 text-sm text-foreground/75 leading-relaxed">
            <li>You must be at least 13 years old to use DBrief.</li>
        ...
        <Section icon={<FileText className="h-4 w-4" />} title="3. Free and Premium Tiers">
          <div className="space-y-3 text-sm text-foreground/75 leading-relaxed">
            ...
            <div>
              <p className="font-medium text-foreground/90 mb-1">DBrief Premium additionally includes:</p>
        ...
        <Section icon={<CreditCard className="h-4 w-4" />} title="4. Subscriptions and Payment">
          <ul className="space-y-2 text-sm text-foreground/75 leading-relaxed">
            <li>DBrief Premium is a monthly subscription, currently priced at <strong className="text-foreground/90">£5.99/month</strong> (introductory pricing, subject to change).</li>
        ...
        <Section icon={<FileText className="h-4 w-4" />} title="5. AI-Generated Content">
          <ul className="space-y-2 text-sm text-foreground/75 leading-relaxed">
            <li>DBrief uses OpenAI's API to generate debrief responses, insights, and reports. AI responses are generated automatically and are not reviewed by a human before you see them.</li>
        ...
        <Section icon={<FileText className="h-4 w-4" />} title="6. Your Content">
          <ul className="space-y-2 text-sm text-foreground/75 leading-relaxed">
            <li>You retain ownership of all content you create in DBrief, including journal entries, goals, and debrief responses.</li>
            <li>By using DBrief, you grant us a limited licence to store, process, and (where required for AI features) transmit your content solely to operate the service.</li>
            <li>You must not use DBrief to store or transmit any content that is illegal, harmful, defamatory, or that infringes the rights of others.</li>
          </ul>
        </Section>
        ...
        <Section icon={<FileText className="h-4 w-4" />} title="8. Availability and Changes">
          <ul className="space-y-2 text-sm text-foreground/75 leading-relaxed">
            <li>We aim to keep DBrief available at all times but do not guarantee uninterrupted access. Maintenance, updates, or events outside our control may cause temporary downtime.</li>
            ...
            <li>If we discontinue DBrief, we will give reasonable advance notice and issue a pro-rata refund for any unused paid period.</li>
          </ul>
        </Section>
        ...
        <Section icon={<AlertTriangle className="h-4 w-4" />} title="10. Limitation of Liability">
          <ul className="space-y-2 text-sm text-foreground/75 leading-relaxed">
            <li>DBrief is provided "as is" without warranties of any kind, express or implied.</li>
        ...
        <Section icon={<Shield className="h-4 w-4" />} title="11. Privacy">
          <p className="text-sm text-foreground/75 leading-relaxed">
            Your use of DBrief is also governed by our{" "}
            <button
