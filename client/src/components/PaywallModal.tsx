...
export default function PaywallModal({ isOpen, onClose, featureName }: PaywallModalProps) {
  ...
  // Native: show Stripe's embedded checkout inside the app (no external browser).
  ...
  function handleSubscribe() {
    ...
    if (Capacitor.isNativePlatform()) {
      // Open the embedded Stripe checkout sheet inside the app.
      // No external browser, no window.open(), no return-journey issues.
  ...
  return (
    <>
      ...
      {/* Embedded Stripe checkout — renders inside the app, no external browser */}
      <StripeCheckoutModal
        isOpen={showEmbedded}
        onClose={() => {
